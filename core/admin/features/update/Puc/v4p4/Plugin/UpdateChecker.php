...
if ( !class_exists('H4APlugin\\Core\\Admin\\Puc_v4p4_Plugin_UpdateChecker', false) ):
	...
	class Puc_v4p4_Plugin_UpdateChecker extends Puc_v4p4_UpdateChecker {
		...
		public function requestInfo($queryArgs = array()) {
			list($pluginInfo, $result) = $this->requestMetadata('H4APlugin\\Core\\Admin\\Puc_v4p4_Plugin_Info', 'request_info', $queryArgs);
