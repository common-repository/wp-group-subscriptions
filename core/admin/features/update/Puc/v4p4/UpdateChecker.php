...
if ( !class_exists('H4APlugin\\Core\\Admin\\Puc_v4p4_UpdateChecker', false) ):
	...
	abstract class Puc_v4p4_UpdateChecker {
		...
		public function maybeInitDebugBar() {
			if ( class_exists('H4APlugin\\Core\\Admin\\Debug_Bar', false) && file_exists(dirname(__FILE__ . '/DebugBar')) ) {
