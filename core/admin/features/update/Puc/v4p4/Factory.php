...
if ( !class_exists('H4APlugin\\Core\\Admin\\Puc_v4p4_Factory', false) ):
	...
	class Puc_v4p4_Factory {
		...
		public static function buildUpdateChecker($metadataUrl, $fullPath, $slug = '', $checkPeriod = 12, $optionName = '', $muPluginFile = '') {
			...
			if ( empty($service) ) {
				...
				$checkerClass = 'H4APlugin\\Core\\Admin\\' . $type . '_UpdateChecker';
			} else {
				//You can also use a VCS repository like GitHub.
				$checkerClass = 'Vcs_' . $type . 'UpdateChecker';
				$apiClass = 'H4APlugin\\Core\\Admin\\' . $service . 'Api';
			}
